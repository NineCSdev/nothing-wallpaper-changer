...
| `SET_WALLPAPER`                                        | To set your wallpaper — the entire point of the app                                                                             |
...
- **Your images are excluded.** Local copies of your photos are explicitly excluded from cloud
  backup, so your photos are not uploaded by this app's backup.
...
- If you would rather none of this happen, turn off backup for this app in your device's backup
...
- Uninstall the app to erase every trace of its data from your device.

Because nothing is collected or transmitted, there is no server-side data to request, export or
delete.
